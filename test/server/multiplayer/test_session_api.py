...
async def test_create_session(clean_database, test_client, preset_manager, default_game_list, mocker: MockerFixture):
    # Setup
...
async def test_create_session_too_long(clean_database, test_client):
    # Setup
    database.User.create(id=1234, discord_id=5678, name="The Name")
    test_client.set_logged_in_user(1234)
