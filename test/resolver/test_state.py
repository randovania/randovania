...
def test_collected_pickup_indices():
    ...
    s = state.State(resources, 99, None, None, None, None)
...
def test_add_pickup_to_state():
    # Starting State
    s = state.State({}, 99, None, None, None, None)
...
def test_assign_pickup_to_index(collected: bool, empty_patches):
    ...
    starting = state.State(starting_resources, 99, None, empty_patches, None, None)
...
def test_assign_pickup_to_starting_items(empty_patches):
    ...
    starting = state.State({}, 99, None, empty_patches, None, resource_database)
...
def test_state_with_pickup():
    # Setup
    starting = state.State({}, 99, None, None, None, None)
