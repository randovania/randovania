...
_test_descriptions = [
    _create_test_layout_description(
        ...
        pickup_mapping=[57, 82, 83, 75, 2, 38, 52, 2, 112, 8, 17, 4, 2, 13, 4, 15, 2, 2, 27, 2, 43, 23, 79, 2, 19, 2,
                        37, 4, 2, 2, 88, 2, 2, 68, 2, 2, 2, 21, 4, 2, 7, 2, 46, 2, 59, 8, 2, 8, 44, 114, 2, 2, 24, 8,
                        17, 2, 2, 2, 69, 4, 2, 74, 17, 4, 2, 92, 115, 2, 2, 2, 2, 2, 2, 76, 17, 2, 8, 118, 4, 91, 1, 8,
                        2, 4, 2, 8, 4, 86, 4, 2, 2, 4, 2, 0, 4, 8, 2, 2, 53, 4, 2, 2, 50, 109, 2, 117, 2, 116, 2, 39,
                        100, 2, 102, 45, 106, 2, 2, 11, 4]
    ...
    _create_test_layout_description(
        ...
        pickup_mapping=[2, 59, 38, 2, 0, 2, 23, 46, 57, 8, 4, 92, 13, 75, 2, 8, 2, 53, 2, 2, 2, 44, 2, 2, 45, 106, 102,
                        2, 8, 4, 2, 4, 2, 37, 76, 2, 88, 17, 2, 114, 2, 43, 2, 2, 2, 2, 50, 74, 17, 2, 2, 2, 19, 2, 2,
                        115, 8, 2, 52, 118, 24, 21, 4, 2, 2, 79, 2, 2, 2, 2, 7, 2, 8, 82, 2, 109, 2, 2, 4, 8, 2, 4, 86,
                        116, 39, 2, 4, 2, 4, 91, 8, 15, 11, 2, 4, 17, 17, 117, 4, 2, 2, 100, 2, 112, 2, 83, 68, 4, 4, 2,
                        24, 69, 1, 8, 2, 2, 2, 4, 4]
    ...
    _create_test_layout_description(
        ...
        pickup_mapping=[86, 2, 88, 115, 2, 2, 92, 0, 2, 2, 59, 57, 76, 112, 44, 114, 2, 37, 2, 4, 8, 13, 116, 2, 69, 2,
                        24, 2, 4, 2, 4, 2, 17, 2, 7, 39, 2, 11, 117, 2, 118, 2, 8, 53, 2, 2, 4, 2, 4, 4, 46, 17, 38, 2,
                        8, 17, 2, 2, 2, 8, 21, 43, 17, 8, 2, 82, 8, 4, 2, 2, 2, 4, 102, 74, 4, 15, 2, 52, 8, 45, 79, 2,
                        2, 2, 50, 2, 19, 8, 91, 27, 4, 2, 4, 2, 2, 2, 23, 2, 83, 4, 1, 2, 68, 2, 75, 2, 2, 4, 4, 2, 100,
                        2, 2, 2, 2, 106, 109, 2, 2]
