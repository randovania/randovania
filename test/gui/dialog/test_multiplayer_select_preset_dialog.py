...
def test_select_preset_single_game(skip_qtbot, preset_manager):
    ...
    dialog.select_preset_widget.create_preset_tree.select_preset(
...
def test_select_preset_two_games_with_name(skip_qtbot, preset_manager):
    ...
    options = MagicMock()
    dialog = MultiplayerSelectPresetDialog(window_manager, options, allowed_games=[RandovaniaGame.BLANK, game],
