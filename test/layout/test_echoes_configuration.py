...
@pytest.fixture(
    params=[
        {"encoded": b'@\x00\x05\x8c\x7f\x17\x0c\x04\xb0\x0f\xf8',
         "sky_temple_keys": LayoutSkyTempleKeyMode.NINE.value,
         },
        {"encoded": b'@\x00\x00\x0c\x7f\x17\x0c\x04\xb0\x0f\xf8',
         "sky_temple_keys": LayoutSkyTempleKeyMode.ALL_BOSSES.value,
         },
        {"encoded": b'@\x00\x02"\xff\x17\x0c\x04\xb0\x0f\xf8',
         "sky_temple_keys": LayoutSkyTempleKeyMode.TWO.value,
         "energy_per_tank": 280,
         },
        {"encoded": b'@\x00\x00\x8c\x7fE\xec\x04\xb0\x0f\xf8',
         "sky_temple_keys": LayoutSkyTempleKeyMode.ALL_GUARDIANS.value,
         "varia_suit_damage": 18.0,
         },
        {"encoded": b'\x10\x00\x00\x8c\x7f\x17\x0c\x04\xb0\x0f\xf8',
