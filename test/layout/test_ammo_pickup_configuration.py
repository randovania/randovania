...
@pytest.fixture(
    params=[
        ...
        {"game": RandovaniaGame.METROID_PRIME_ECHOES, "encoded": b'\x8aH\x91\x00',
         "pickups_state": {"Missile Expansion": {"ammo_count": [10], "pickup_count": 12, "starting_count": 12}}},
        {"game": RandovaniaGame.METROID_PRIME_ECHOES, "encoded": b'\x8fH\x91\x00',
         "pickups_state": {"Missile Expansion": {"ammo_count": [15], "pickup_count": 12, "starting_count": 12}}},
