...
def test_reach_size_from_start_echoes(
    ...
    assert list(reach.nodes) == nodes(
        ...
        "Temple Grounds/Torvus Transport Access/Front of Door to Path of Eyes",
        ...
        "Torvus Bog/Temple Transport Access/Front of Door to Transport to Temple Grounds",
        "Torvus Bog/Temple Transport Access/Door to Torvus Lagoon",
        "Torvus Bog/Torvus Lagoon/Door to Temple Transport Access",
        "Torvus Bog/Torvus Lagoon/Front of Door to Temple Transport Access",
        ...
        "Torvus Bog/Path of Roots/Front of Door to Torvus Lagoon",
        ...
        "Torvus Bog/Great Bridge/Front of Door to Path of Roots",
    )
    assert len(list(reach.safe_nodes)) == 27
