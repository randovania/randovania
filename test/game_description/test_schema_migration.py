...
from randovania.game_description import data_reader, data_writer, game_description_migration


def test_round_trip_small(test_files_dir):
    # Setup
    original_data = test_files_dir.read_json("prime2_small_v1.json")
    migrated_data = game_description_migration.migrate_to_current(original_data, RandovaniaGame.METROID_PRIME_ECHOES)
