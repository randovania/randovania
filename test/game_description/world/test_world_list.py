...
def test_connections_from_dock_blast_shield(empty_patches):
    ...
    node_1 = DockNode("Node 1", False, None, "", {}, 0, NodeIdentifier.create("W", "Area 2", "Node 2"), weak_1)
    node_2 = DockNode("Node 2", False, None, "", {}, 1, NodeIdentifier.create("W", "Area 1", "Node 1"), weak_2)
