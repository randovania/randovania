...
def test_invalid_db():
    ...
    assert errors == [
        ...
        "World/Area 1/Door to Area 2 (Dock) connects to 'region World/area Area 2/node Door to Area 1', but that dock connects to 'region World/area Area 1/node Door to Area 2 (Generic)' instead.",
