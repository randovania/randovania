...
def test_patch_data_creation(test_files_dir):
    # Load the RDV game
    game_json = json_lib.read_path(test_files_dir.joinpath("rdvgames", "super_metroid", "sdm_test_game.rdvgame"))
    ...
    expected_json = test_files_dir.read_json("patcher_data", "super_metroid", "sdm_expected_result.json")
