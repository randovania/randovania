...
def test_patch_data_creation():
    # Load the RDV game
    game_file = open("test/games/super_metroid/patcher/sdm_test_game.rdvgame", "r")
    ...
    json_file = open("test/games/super_metroid/patcher/expected_result.json", "r")
