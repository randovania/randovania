...
def test_export_game(test_files_dir, mocker, patch_data_name: str, tmp_path):
    # TODO: Activate rest of the test when patcher is in RDV
    # Setup
    ...
    #     side_effect=validate_schema
    # )

    patch_data = test_files_dir.read_json("patcher_data", "samus_returns", f"{patch_data_name}.json")
