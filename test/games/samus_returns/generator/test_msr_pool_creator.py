...
@pytest.mark.parametrize(
    ("metroids", "stronger_metroids", "bosses", "artifacts"),
    [(False, False, True, 5), (False, True, False, 15), (True, False, True, 40), (True, True, True, 40)],
)
def test_msr_artifact_pool_should_throw_on_invalid_config(
    msr_game_description, metroids, stronger_metroids, bosses, artifacts
):
    # Setup
