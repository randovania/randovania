...
def test_apply_remote_execution_patch(game: RandovaniaGame, dol_file,
    ...
    if game == RandovaniaGame.METROID_PRIME:
        assert results == (b'\x94\x21\xff\xcc\x7c\x08\x02\xa6\x90\x01\x00\x38\xbf\xc1\x00\x2c\x7c\x7f\x1b\x78'
                           ...
                           b'\x41\x82\xff\xf8\x80\x03\x00\x08\x2c\x00\x00\x00\x41\x81\xff\xec\xbb\xc1\x00\x2c'
        ...
        assert results == (b'\x94\x21\xff\xcc\x7c\x08\x02\xa6\x90\x01\x00\x38\xbf\xc1\x00\x2c\x7c\x7f\x1b\x78'
                           ...
                           b'\x41\x81\xff\xf8\xbb\xc1\x00\x2c\x80\x01\x00\x38\x7c\x08\x03\xa6\x38\x21\x00\x34'
...
def test_create_remote_execution_body(game: RandovaniaGame,
    ...
    print(f'0x{patch_address - string_display.update_hint_state:X}')
    for i in range(50):
        print("b'" + "".join(f"\\x{x:02x}" for x in patch_bytes[i * 20:(i + 1) * 20]) + "'")
