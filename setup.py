...
def rdv_version_scheme(version: setuptools_scm.ScmVersion) -> str:
...
git_hash = {version.short_node!r}
full_git_hash = {version.node!r}
...
setup(
    ...
    use_scm_version={
        "version_scheme": rdv_version_scheme,
    },
)
