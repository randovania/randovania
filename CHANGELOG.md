...
- Fixed: Upper Research Core door opening if a custom blast shield is destroyed while door is unpowered
...
- Fixed: Missing black bars in Elite Research bottom platform activation cutscene
- Fixed: Black bars sometimes disappearing prematurely in Chozo Ice Temple cutscene
