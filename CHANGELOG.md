...
- Added: In Landing Site: Can now reach missile behind the ship with Single Room OoB

##### Phendrana Drifts

- Added : In Ruined Courtyard: Can now traverse between Top Platfrom and Specimen Storage with Scan Dash (beginner)
