...
- Fixed: Hive Totem - Incorrect water height when *not* skipping cutscene, improved cutscene skip timing
...
- Fixed: Energy Core - Puzzle music no longer incorrectly plays if player leaves room during countdown
- Fixed: Ruined Shrine: Beetle music incorrectly continues playing after leaving via morph tunnel
...
- Changed: Sun Tower Elevator: [Cosmetic] Samus Actor turned 90 degrees in cutscene
