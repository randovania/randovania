...
- Changed: Obtaining the Pickup underneath Drogyga with a Water Bomb Jump and Normal Bomb is now Intermediate, for consistency with other out of water bomb jumps.
- Changed: The dangerous logic surrounding the water underneath Drogyga in terms of getting up the left left ledge and across to the right ledge is now waived. Logically by construction, if the water is there then Drogya has been defeated, whic requires Grapple Beam, which is a solutuion to the connections that are changed.
...
- Added: Current and total DNA count are now displayed in the "Samus" menu on the pause screen. A cosmetic option is also available to display it in the HUD, next to the Death Counter (if enabled).
