...
- Changed: The logic database structure now has split Hanubia in two sections, one normal section and one that is used during the escape sequence. The purpose of this split is to avoid the "Before Escape Sequence" conditions, meaning that finishing the game is no longer locked behind a "dangerous" resource.
