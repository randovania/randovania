...
- Fixed: Some cases of not correctly identifying which nodes are reachable in contexts of randomized doors that are normally different types on each side.
