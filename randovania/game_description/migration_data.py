...
def get_new_start_loc_from_old_start_loc(game: str, old_loc_str: str) -> dict[str, str]:
    old_loc = AreaIdentifier.from_string(old_loc_str)
    ...
    return NodeIdentifier(old_loc, node_name).as_string