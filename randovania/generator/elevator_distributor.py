...
def get_dock_connections_for_elevators(teleporters: TeleporterConfiguration,
    ...
    if not teleporters.is_vanilla:
        ...
        elevator_db = create_elevator_database(region_list, teleporters.editable_teleporters,
                                                                    elevator_dock_types)
        if teleporters.mode == TeleporterShuffleMode.ECHOES_SHUFFLED:
            from randovania.games.prime2.generator.elevator_distributor import elevator_echoes_shuffled
