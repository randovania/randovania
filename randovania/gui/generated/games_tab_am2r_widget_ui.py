...
class Ui_AM2RGameTabWidget(object):
    def setupUi(self, AM2RGameTabWidget):
        ...
        self.faq_scroll_area_contents.setGeometry(QRect(0, 0, 96, 48))
        ...
        self.differences_scroll_contents.setGeometry(QRect(0, 0, 135, 7788))
        ...
        self.hints_scroll_area_contents.setGeometry(QRect(0, 0, 755, 630))
        ...
        self.hint_item_names_scroll_contents.setGeometry(QRect(0, 0, 99, 462))
        ...
        self.hint_item_names_tree_widget.setHorizontalHeaderItem(0, __qtablewidgetitem23)
        __qtablewidgetitem24 = QTableWidgetItem()
        self.hint_item_names_tree_widget.setHorizontalHeaderItem(1, __qtablewidgetitem24)
        __qtablewidgetitem25 = QTableWidgetItem()
        self.hint_item_names_tree_widget.setHorizontalHeaderItem(2, __qtablewidgetitem25)
        __qtablewidgetitem26 = QTableWidgetItem()
        self.hint_item_names_tree_widget.setHorizontalHeaderItem(3, __qtablewidgetitem26)
        ...
        AM2RGameTabWidget.addTab(self.hint_item_names_tab, "")
    ...
    def retranslateUi(self, AM2RGameTabWidget):
        ...
        self.hint_item_names_label.setText(QCoreApplication.translate("AM2RGameTabWidget", u"<html><head/><body><p>When\n"
...
"                                            ", None))
        ___qtablewidgetitem23 = self.hint_item_names_tree_widget.horizontalHeaderItem(0)
        ___qtablewidgetitem23.setText(QCoreApplication.translate("AM2RGameTabWidget", u"Item", None));
        ___qtablewidgetitem24 = self.hint_item_names_tree_widget.horizontalHeaderItem(1)
        ___qtablewidgetitem24.setText(QCoreApplication.translate("AM2RGameTabWidget", u"Precise Category", None));
        ___qtablewidgetitem25 = self.hint_item_names_tree_widget.horizontalHeaderItem(2)
        ___qtablewidgetitem25.setText(QCoreApplication.translate("AM2RGameTabWidget", u"General Category", None));
        ___qtablewidgetitem26 = self.hint_item_names_tree_widget.horizontalHeaderItem(3)
        ___qtablewidgetitem26.setText(QCoreApplication.translate("AM2RGameTabWidget", u"Broad Category", None));
        AM2RGameTabWidget.setTabText(AM2RGameTabWidget.indexOf(self.hint_item_names_tab), QCoreApplication.translate("AM2RGameTabWidget", u"Hint Item Names", None))
        pass
    # retranslateUi
