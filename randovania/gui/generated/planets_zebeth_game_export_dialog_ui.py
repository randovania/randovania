...
class Ui_PlanetsZebethGameExportDialog(object):
    def setupUi(self, PlanetsZebethGameExportDialog):
        ...
        PlanetsZebethGameExportDialog.resize(527, 338)
        ...
        self.input_file_button = QPushButton(PlanetsZebethGameExportDialog)
        self.input_file_button.setObjectName(u"input_file_button")

        self.gridLayout.addWidget(self.input_file_button, 3, 1, 1, 1)

        self.output_file_edit = QLineEdit(PlanetsZebethGameExportDialog)
        ...
        self.output_file_label = QLabel(PlanetsZebethGameExportDialog)
    ...
    def retranslateUi(self, PlanetsZebethGameExportDialog):
        ...
        self.output_file_button.setText(QCoreApplication.translate("PlanetsZebethGameExportDialog", u"Select Folder", None))
        self.input_file_edit.setPlaceholderText(QCoreApplication.translate("PlanetsZebethGameExportDialog", u"Path to Metroid Planets 1.27g folder", None))
        self.input_file_label.setText(QCoreApplication.translate("PlanetsZebethGameExportDialog", u"Input Directory (1.27g)", None))
        ...
        self.input_file_button.setText(QCoreApplication.translate("PlanetsZebethGameExportDialog", u"Select Folder", None))
        self.output_file_edit.setPlaceholderText(QCoreApplication.translate("PlanetsZebethGameExportDialog", u"Path where to place the randomized game", None))
        self.output_format_label.setText(QCoreApplication.translate("PlanetsZebethGameExportDialog", u"Output Format", None))
        self.output_file_label.setText(QCoreApplication.translate("PlanetsZebethGameExportDialog", u"Output Directory", None))
    # retranslateUi
