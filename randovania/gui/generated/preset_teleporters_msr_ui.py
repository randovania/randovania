...
class Ui_PresetTeleportersMSR(object):
    def setupUi(self, PresetTeleportersMSR):
        if not PresetTeleportersMSR.objectName():
            PresetTeleportersMSR.setObjectName(u"PresetTeleportersMSR")
        PresetTeleportersMSR.resize(505, 463)
        self.centralWidget = QWidget(PresetTeleportersMSR)
        ...
        self.teleporters_line.setFrameShape(QFrame.HLine)
        self.teleporters_line.setFrameShadow(QFrame.Sunken)
        ...
        PresetTeleportersMSR.setCentralWidget(self.centralWidget)

        self.retranslateUi(PresetTeleportersMSR)

        QMetaObject.connectSlotsByName(PresetTeleportersMSR)
    # setupUi

    def retranslateUi(self, PresetTeleportersMSR):
        PresetTeleportersMSR.setWindowTitle(QCoreApplication.translate("PresetTeleportersMSR", u"Transporters", None))
        self.teleporters_description_label.setText(QCoreApplication.translate("PresetTeleportersMSR", u"<html><head/><body><p>&lt;description generated dynamically&gt;</p></body></html>", None))
        self.teleporters_source_group.setTitle(QCoreApplication.translate("PresetTeleportersMSR", u"Transporters to randomize", None))
        self.teleporters_target_group.setTitle(QCoreApplication.translate("PresetTeleportersMSR", u"Valid teleporter targets", None))
    # retranslateUi
