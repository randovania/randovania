...
class Ui_PresetDreadEnergy(object):
    ...
    def retranslateUi(self, PresetDreadEnergy):
        ...
        self.constant_environment_damage_label.setText(QCoreApplication.translate("PresetDreadEnergy", u"<html><head/><body><p>When enabled, cold and heated rooms, or lava, will deal a fixed damage per second instead of the normal behavior of scaling up over time.</p><p>Logic always assume this setting is <span style=\" font-weight:700;\">disabled</span>.</p></body></html>", None))
    # retranslateUi
