...
class Ui_PresetMSRPatches(object):
    def setupUi(self, PresetMSRPatches):
        ...
        self.scroll_contents.setGeometry(QRect(0, 0, 621, 746))
    ...
    def retranslateUi(self, PresetMSRPatches):
        ...
        self.elevator_grapple_blocks_label.setText(QCoreApplication.translate("PresetMSRPatches", u"<html><head/><body><p>Removes the Grapple Blocks that are near the exit elevators of certain areas. These include:</p><ul style=\"margin-top: 0px; margin-bottom: 0px; margin-left: 0px; margin-right: 0px; -qt-list-indent: 1;\"><li style=\" margin-top:12px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Area 4 Central Caves to Area 4 - Crystal Mines</li><li style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Area 5 - Tower Lobby to Area 6 </li><li style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Area 6 to Area 7 </li><li style=\" margin-top:0px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Area 7 to Area 8 </li></ul></body></html>", None))
        self.surface_crumbles_check.setText(QCoreApplication.translate("PresetMSRPatches", u"Crumble Blocks in Surface - Cavern Cavity", None))
        ...
        self.reverse_area8_label.setText(QCoreApplication.translate("PresetMSRPatches", u"Removes the wall between the Queen Arena and Hatchling Room, allowing for earlier access into Area 8 by entering the area backwards.", None))
