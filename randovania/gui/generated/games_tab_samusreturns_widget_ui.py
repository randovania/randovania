...
class Ui_SamusReturnsGameTabWidget(object):
    def setupUi(self, SamusReturnsGameTabWidget):
        ...
        self.differences_contents.setGeometry(QRect(0, 0, 651, 876))
        ...
        self.hints_scroll_area_contents.setGeometry(QRect(0, 0, 651, 849))
    ...
    def retranslateUi(self, SamusReturnsGameTabWidget):
        ...
        self.differences_label.setText(QCoreApplication.translate("SamusReturnsGameTabWidget", u"<html><head/><body><p>Randovania makes some changes to the original game in order to improve the game experience or to simply fix bugs in the original game.<br/>Many changes are optional and can be disabled in the options Randovania provides, but the following are <span style=\" font-weight:600;\">always</span> there:</p><p><br/><span style=\" font-weight:600;\">General Changes</span></p><ul style=\"margin-top: 0px; margin-bottom: 0px; margin-left: 0px; margin-right: 0px; -qt-list-indent: 1;\"><li style=\" margin-top:12px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Chozo Seals have been repurposed to provide hints for where items are located.</li></ul><ul style=\"margin-top: 0px; margin-bottom: 0px; margin-left: 0px; margin-right: 0px; -qt-list-indent: 1;\"><li style=\" margin-top:12px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">DNA can now be placed anywhere in the world as pickups.</li><ul style=\"margin-top: "
                        ...
                        "aximum capacity.</li></ul><p><span style=\" font-weight:600;\">Enemy Changes</span></p><ul style=\"margin-top: 0px; margin-bottom: 0px; margin-left: 0px; margin-right: 0px; -qt-list-indent: 1;\"><li style=\" margin-top:12px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Metroids now can drop any item instead of just DNA.</li></ul><ul style=\"margin-top: 0px; margin-bottom: 0px; margin-left: 0px; margin-right: 0px; -qt-list-indent: 1;\"><li style=\" margin-top:12px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">The fleeing Gamma Metroids no longer flee after taking a certain amount of damage. They also always spawn in the same location rather than being random.</li></ul><ul style=\"margin-top: 0px; margin-bottom: 0px; margin-left: 0px; margin-right: 0px; -qt-list-indent: 1;\"><li style=\" margin-top:12px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Power Bomb drop chance"
                        "s from enemies has been slightly increased.</li><li style=\" margin-top:12px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Beams have been rebalanced against Proteus Ridley.</li></ul><p><span style=\" font-weight:600;\">Room Changes</span></p><ul style=\"margin-top: 0px; margin-bottom: 0px; margin-left: 0px; margin-right: 0px; -qt-list-indent: 1;\"><li style=\" margin-top:12px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">The hazardous liquid that prevents leaving areas early has been removed.</li></ul><ul style=\"margin-top: 0px; margin-bottom: 0px; margin-left: 0px; margin-right: 0px; -qt-list-indent: 1;\"><li style=\" margin-top:12px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">All designated heat rooms are now properly heated.</li></ul><ul style=\"margin-top: 0px; margin-bottom: 0px; margin-left: 0px; margin-right: 0px; -qt-list-indent: 1;\"><li style=\" margin-to"
                        "p:12px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">The Diggernaut Chase sequence has been removed and the corresponding rooms have been set to their post-chase state.</li><li style=\" margin-top:12px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">The wall blocking the Landing Site from Surface - East after defeating the Queen has been removed.</li><li style=\" margin-top:12px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">In the vanilla game, the Surface area where Proteus Ridley resides is a separate map from the starting Surface. These are normally not connected. This has been changed to warp the player to the other Surface map by passing the Baby blocks in the Landing Site. Once enough DNA is collected to access Ridley, you can no longer warp from Surface West to Surface East.</li></ul><p><span style=\" font-weight:600;\">Door Changes</span></p><ul style=\"margin-to"
                        "p: 0px; margin-bottom: 0px; margin-left: 0px; margin-right: 0px; -qt-list-indent: 1;\"><li style=\" margin-top:12px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Most Charge Beam doors at the entrance and exit of every area have been changed to Power Beam doors, excluding Area 4 - Crystal Mines and Area 6.</li><li style=\" margin-top:12px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Most beam doors are now double-sided. This simplifies traversing through areas in reverse.</li><li style=\" margin-top:12px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Some one-way doors are now two-way to prevent softlocks or make traversal less restrictive. These include: <br/><br/><span style=\" font-weight:600;\">Area 1</span><br/><ul type=\"circle\" style=\"margin-top: 0px; margin-bottom: 0px; margin-left: 0px; margin-right: 0px; -qt-list-indent: 2;\"><li style=\" margin-top:0px; ma"
                        "rgin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Bomb Chamber to Bomb Chamber Access</li></ul></li></ul><ul type=\"circle\" style=\"margin-top: 0px; margin-bottom: 0px; margin-left: 0px; margin-right: 0px; -qt-list-indent: 2;\"><li style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Temple Exterior to Inner Temple East Hall </li></ul></body></html>", None))
