...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menu_action_use_world_graph = QAction(MainWindow)
        self.menu_action_use_world_graph.setObjectName(u"menu_action_use_world_graph")
        self.menu_action_use_world_graph.setCheckable(True)
        self.menu_action_use_world_graph.setChecked(True)
        ...
        self.game_list_contents.setGeometry(QRect(0, 0, 682, 450))
        ...
        self.menu_advanced.addAction(self.menu_action_use_world_graph)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menu_action_use_world_graph.setText(QCoreApplication.translate("MainWindow", u"Use newer generation and validation algorithm", None))
