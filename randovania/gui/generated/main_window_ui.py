...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menu_action_hotkeys = QAction(MainWindow)
        self.menu_action_hotkeys.setObjectName(u"menu_action_hotkeys")
        ...
        self.game_list_contents.setGeometry(QRect(0, 0, 680, 410))
        ...
        self.menu_bar.setGeometry(QRect(0, 0, 688, 33))
        ...
        self.menu_preferences.addAction(self.menu_action_hotkeys)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menu_action_hotkeys.setText(QCoreApplication.translate("MainWindow", u"Hotkeys", None))
