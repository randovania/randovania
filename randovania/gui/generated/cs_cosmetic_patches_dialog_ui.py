...
class Ui_CSCosmeticPatchesDialog(object):
    def setupUi(self, CSCosmeticPatchesDialog):
        ...
        self.scroll_area_contents.setGeometry(QRect(0, 0, 404, 374))
        ...
        self.mychar_img_label.setAlignment(Qt.AlignCenter)
        ...
        self.mychar_name_label.setAlignment(Qt.AlignCenter)
        ...
        self.mychar_description_label.setTextFormat(Qt.MarkdownText)
        ...
        self.music_type_description_label.setTextFormat(Qt.MarkdownText)
