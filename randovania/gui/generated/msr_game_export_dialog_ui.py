...
class Ui_MSRGameExportDialog(object):
    def setupUi(self, MSRGameExportDialog):
        ...
        MSRGameExportDialog.resize(501, 529)
        ...
        self.root_layout.addLayout(self.version_layout, 6, 0, 1, 3)
        ...
        self.root_layout.addLayout(self.target_platform_layout, 5, 0, 1, 3)

        self.accept_button = QPushButton(MSRGameExportDialog)
        self.accept_button.setObjectName(u"accept_button")

        self.root_layout.addWidget(self.accept_button, 13, 0, 1, 1)
        ...
        self.root_layout.addWidget(self.output_tab_widget, 9, 0, 2, 3)

        self.cancel_button = QPushButton(MSRGameExportDialog)
        self.cancel_button.setObjectName(u"cancel_button")

        self.root_layout.addWidget(self.cancel_button, 13, 2, 1, 1)

        self.verticalSpacer = QSpacerItem(20, 40, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Minimum)

        self.root_layout.addItem(self.verticalSpacer, 6, 0, 1, 3)
        ...
        self.root_layout.addWidget(self.console_reminder_label, 7, 0, 1, 3)
    ...
    def retranslateUi(self, MSRGameExportDialog):
        ...
        self.input_file_button.setText(QCoreApplication.translate("MSRGameExportDialog", u"Select Folder", None))
        ...
        self.input_file_label.setText(QCoreApplication.translate("MSRGameExportDialog", u"Input Path (An extracted unmodified Samus Returns RomFS)", None))
