...
class Ui_PresetEchoesPatches(object):
    def setupUi(self, PresetEchoesPatches):
        ...
        self.warp_to_start_line.setFrameShape(QFrame.HLine)
        self.warp_to_start_line.setFrameShadow(QFrame.Sunken)
        ...
        self.save_doors_line.setFrameShape(QFrame.HLine)
        self.save_doors_line.setFrameShadow(QFrame.Sunken)
        ...
        self.new_patcher_line.setFrameShape(QFrame.HLine)
        self.new_patcher_line.setFrameShadow(QFrame.Sunken)
        ...
        self.portal_rando_line.setFrameShape(QFrame.HLine)
        self.portal_rando_line.setFrameShadow(QFrame.Sunken)
        ...
        self.inverted_line.setFrameShape(QFrame.HLine)
        self.inverted_line.setFrameShadow(QFrame.Sunken)
