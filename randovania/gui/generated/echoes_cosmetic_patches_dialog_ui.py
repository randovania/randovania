...
from randovania.gui.lib.foldable import *  # type: ignore
...
class Ui_EchoesCosmeticPatchesDialog(object):
    def setupUi(self, EchoesCosmeticPatchesDialog):
        ...
        self.scroll_area_contents.setGeometry(QRect(0, 0, 448, 2310))
        ...
        self.suits_foldable.setProperty("folded", True)
        ...
        self.simple_name_label.setAlignment(Qt.AlignCenter)
        ...
        self.simple_img_label.setAlignment(Qt.AlignCenter)
        ...
        self.varia_name_label.setAlignment(Qt.AlignCenter)
        ...
        self.varia_img_label.setAlignment(Qt.AlignCenter)
        ...
        self.dark_name_label.setAlignment(Qt.AlignCenter)
        ...
        self.dark_img_label.setAlignment(Qt.AlignCenter)
        ...
        self.light_name_label.setAlignment(Qt.AlignCenter)
        ...
        self.light_img_label.setAlignment(Qt.AlignCenter)
        ...
        self.options_foldable.setProperty("folded", True)
    ...
    def retranslateUi(self, EchoesCosmeticPatchesDialog):
        ...
        self.suits_foldable.setProperty("title", QCoreApplication.translate("EchoesCosmeticPatchesDialog", u"Suit Colors", None))
        ...
        self.options_foldable.setProperty("title", QCoreApplication.translate("EchoesCosmeticPatchesDialog", u"In-Game Options", None))
