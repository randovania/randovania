...
class Ui_DreadCosmeticPatchesDialog(object):
    def setupUi(self, DreadCosmeticPatchesDialog):
        ...
        self.scroll_area_contents.setGeometry(QRect(0, -326, 384, 644))
        ...
        self.music_slider = QSlider(self.game_changes_box)
        ...
        self.ambience_slider = QSlider(self.game_changes_box)
        ...
        self.ambience_slider.setOrientation(Qt.Horizontal)
