...
class Ui_TrackerWindow(object):
    def setupUi(self, TrackerWindow):
        ...
        self.pickups_scroll_contents.setGeometry(QRect(0, 0, 333, 404))
        ...
        self.teleporters_scroll_contents.setGeometry(QRect(0, 0, 333, 404))
        ...
        self.tab_configurable_node = QWidget()
        self.tab_configurable_node.setObjectName(u"tab_configurable_node")
        self.tab_configurable_node_layout = QVBoxLayout(self.tab_configurable_node)
        self.tab_configurable_node_layout.setSpacing(6)
        self.tab_configurable_node_layout.setContentsMargins(11, 11, 11, 11)
        self.tab_configurable_node_layout.setObjectName(u"tab_configurable_node_layout")
        self.tab_configurable_node_layout.setContentsMargins(0, 0, 0, 0)
        self.configurable_node_scroll_area = QScrollArea(self.tab_configurable_node)
        self.configurable_node_scroll_area.setObjectName(u"configurable_node_scroll_area")
        sizePolicy.setHeightForWidth(self.configurable_node_scroll_area.sizePolicy().hasHeightForWidth())
        self.configurable_node_scroll_area.setSizePolicy(sizePolicy)
        self.configurable_node_scroll_area.setWidgetResizable(True)
        self.configurable_node_scroll_contents = QWidget()
        self.configurable_node_scroll_contents.setObjectName(u"configurable_node_scroll_contents")
        self.configurable_node_scroll_contents.setGeometry(QRect(0, 0, 331, 402))
        self.configurable_node_scroll_layout = QGridLayout(self.configurable_node_scroll_contents)
        self.configurable_node_scroll_layout.setSpacing(6)
        self.configurable_node_scroll_layout.setContentsMargins(11, 11, 11, 11)
        self.configurable_node_scroll_layout.setObjectName(u"configurable_node_scroll_layout")
        self.configurable_node_scroll_layout.setContentsMargins(3, 3, 3, 3)
        self.configurable_node_scroll_area.setWidget(self.configurable_node_scroll_contents)

        self.tab_configurable_node_layout.addWidget(self.configurable_node_scroll_area)

        self.tab_widget.addTab(self.tab_configurable_node, "")
        ...
        self.menu_bar.setGeometry(QRect(0, 0, 1040, 21))
    ...
    def retranslateUi(self, TrackerWindow):
        ...
        self.tab_widget.setTabText(self.tab_widget.indexOf(self.tab_configurable_node), QCoreApplication.translate("TrackerWindow", u"Configurable Nodes", None))
