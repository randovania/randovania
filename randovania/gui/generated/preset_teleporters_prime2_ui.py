...
class Ui_PresetTeleportersPrime2(object):
    def setupUi(self, PresetTeleportersPrime2):
        ...
        self.teleporters_line_2.setFrameShape(QFrame.HLine)
        self.teleporters_line_2.setFrameShadow(QFrame.Sunken)
        ...
        self.teleporters_line_4.setFrameShape(QFrame.HLine)
        self.teleporters_line_4.setFrameShadow(QFrame.Sunken)
        ...
        self.teleporters_line_3.setFrameShape(QFrame.HLine)
        self.teleporters_line_3.setFrameShadow(QFrame.Sunken)
