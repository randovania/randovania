...
class Ui_PrimeGameTabWidget(object):
    def setupUi(self, PrimeGameTabWidget):
        ...
        self.faq_scroll_area_contents.setGeometry(QRect(0, 0, 432, 364))
        ...
        self.hints_scroll_area_contents.setGeometry(QRect(0, 0, 432, 364))
        ...
        self.hint_item_names_scroll_contents.setGeometry(QRect(0, 0, 432, 364))
