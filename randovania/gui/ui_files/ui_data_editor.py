...
class Ui_DataEditorWindow(object):
    def setupUi(self, DataEditorWindow):
        ...
        self.world_selector_box = QComboBox(self.points_of_interest_content)
        self.world_selector_box.setObjectName(u"world_selector_box")

        self.points_of_interest_layout.addWidget(self.world_selector_box)
        ...
        self.other_node_alternatives_contents.setGeometry(QRect(0, 0, 229, 171))
        self.other_node_alternatives_scroll_area.setWidget(self.other_node_alternatives_contents)

        self.gridLayout.addWidget(self.other_node_alternatives_scroll_area, 1, 0, 1, 3)
