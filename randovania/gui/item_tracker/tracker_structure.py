...
class LabelTrackerElement(BaseTrackerElement):
    """
    A label can embed its own text/style directly instead of relying on the theme, for
    content that isn't actually theme-specific (e.g. a debug-only counter that every theme
    would render identically) - see TrackerTheme.label_for.
    """
