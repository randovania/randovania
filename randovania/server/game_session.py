...
def setup_app(sio: SocketWrapper):
    @sio.exception_on("list_game_sessions")
    ...
    @sio.exception_on("create_game_session")
    def create_game_session(session_name: str):
        ...
        sio.join_session_via_sio(membership)
        return new_session.create_session_entry()

    @sio.exception_on("join_game_session")
    ...
    @sio.exception_on("game_session_admin_session")
    ...
    @sio.exception_on("game_session_admin_player")
    ...
    @sio.exception_on("game_session_collect_pickup")
    ...
    @sio.exception_on("game_session_request_pickups")
