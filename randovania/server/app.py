...
# from randovania.server import async_race, client_check, multiplayer, user_session
...
#     # app.config["GUEST_KEY"] = configuration["guest_secret"].encode("ascii")
# if "guest_secret" in configuration else None
