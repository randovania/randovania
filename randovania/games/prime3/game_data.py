...
game_data: game.GameData = game.GameData(
    ...
    faq=[
        ...
        (
           ...
           "If you collect the ship item from the Federation Landing Site before fighting Rundas, both Rundas and the pirate layers will be active at the same time."
        ),
        (
        ...
        (
            ...
            "Once the item in SkyTown Federation Landing Site is collected, the item in Gearworks becomes accessible."
        ),
        (
