...
from randovania.games.deltarune.layout.artifact_mode import LayoutKeyitemMode
from randovania.generator.item_pool import PoolResults, pickup_creator


def add_keyitem(resource_database: ResourceDatabase,
                  mode: LayoutKeyitemMode,
                  keyitem_minimum_progression: int,
                  ) -> PoolResults:
    """
    :param resource_database:
    :param mode
    :param keyitem_minimum_progression
    :return:
    """
