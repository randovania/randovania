...
def deltarune_preset_tabs(editor: PresetEditor, window_manager: WindowManager):
    ...
    from randovania.games.deltarune.gui.preset_settings.deltarune_generation_tab import PresetdeltaruneGeneration
    return [
        ...
        PresetdeltaruneGeneration(editor, game_description),
