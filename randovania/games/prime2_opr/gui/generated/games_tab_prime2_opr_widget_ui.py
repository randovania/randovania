...
class Ui_EchoesOPRGameTabWidget(object):
    ...
    def retranslateUi(self, BlankGameTabWidget):
        ...
        self.intro_label.setText(QCoreApplication.translate("EchoesOPRGameTabWidget", u"<html><head/><body><p align=\"justify\">The Blank game is used by Randovania to serve as an example of how a game is integrated.</p></body></html>", None))
        self.quick_generate_button.setText(QCoreApplication.translate("EchoesOPRGameTabWidget", u"Quick generate", None))
        BlankGameTabWidget.setTabText(BlankGameTabWidget.indexOf(self.tab_intro), QCoreApplication.translate("EchoesOPRGameTabWidget", u"Introduction", None))
        BlankGameTabWidget.setTabText(BlankGameTabWidget.indexOf(self.tab_generate_game), QCoreApplication.translate("EchoesOPRGameTabWidget", u"Play", None))
        self.faq_label.setText(QCoreApplication.translate("EchoesOPRGameTabWidget", u"# updated from code", None))
        BlankGameTabWidget.setTabText(BlankGameTabWidget.indexOf(self.faq_tab), QCoreApplication.translate("EchoesOPRGameTabWidget", u"FAQ", None))
        BlankGameTabWidget.setTabText(BlankGameTabWidget.indexOf(self.pickup_hint_features_tab), QCoreApplication.translate("EchoesOPRGameTabWidget", u"Pickup Hint Features", None))
        pass
    # retranslateUi
