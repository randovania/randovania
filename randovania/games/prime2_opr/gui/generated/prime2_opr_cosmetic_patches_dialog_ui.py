...
################################################################################
## Form generated from reading UI file 'prime2_opr_cosmetic_patches_dialog.ui'
##
...
class Ui_EchoesOPRCosmeticPatchesDialog(object):
    ...
    def retranslateUi(self, BlankCosmeticPatchesDialog):
        BlankCosmeticPatchesDialog.setWindowTitle(QCoreApplication.translate("EchoesOPRCosmeticPatchesDialog", u"EchoesOPR Game - Cosmetic Options", None))
        self.reset_button.setText(QCoreApplication.translate("EchoesOPRCosmeticPatchesDialog", u"Reset to Defaults", None))
        self.accept_button.setText(QCoreApplication.translate("EchoesOPRCosmeticPatchesDialog", u"Accept", None))
        self.cancel_button.setText(QCoreApplication.translate("EchoesOPRCosmeticPatchesDialog", u"Cancel", None))
    # retranslateUi
