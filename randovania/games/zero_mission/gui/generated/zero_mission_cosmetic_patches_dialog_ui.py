...
################################################################################
## Form generated from reading UI file 'zero_mission_cosmetic_patches_dialog.ui'
##
...
class Ui_MZMCosmeticPatchesDialog(object):
    ...
    def retranslateUi(self, BlankCosmeticPatchesDialog):
        BlankCosmeticPatchesDialog.setWindowTitle(QCoreApplication.translate("MZMCosmeticPatchesDialog", u"MZM Game - Cosmetic Options", None))
        self.reset_button.setText(QCoreApplication.translate("MZMCosmeticPatchesDialog", u"Reset to Defaults", None))
        self.accept_button.setText(QCoreApplication.translate("MZMCosmeticPatchesDialog", u"Accept", None))
        self.cancel_button.setText(QCoreApplication.translate("MZMCosmeticPatchesDialog", u"Cancel", None))
    # retranslateUi
