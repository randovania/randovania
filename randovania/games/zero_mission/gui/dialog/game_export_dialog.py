...
class MZMGameExportDialog(GameExportDialog[MZMConfiguration]):
    ...
    def update_per_game_options(self, per_game: PerGameOptions) -> MZMPerGameOptions:
        assert isinstance(per_game, MZMPerGameOptions)
