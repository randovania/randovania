...
from randovania.gui.generated.preset_teleporters_am2r_ui import (
    Ui_PresetTeleportersAM2R,
)
...
class PresetTeleportersAM2R(PresetTeleporterTab, Ui_PresetTeleportersAM2R, NodeListHelper):
    ...
    def _create_source_teleporters(self):
        ...
        checks: dict[NodeIdentifier, QtWidgets.QCheckBox] = {
            loc: self._create_check_for_source_teleporters(
                loc, region_list.node_by_identifier(loc).extra.get("teleporter_name_suffix", "")
            )
    ...
    def on_preset_changed(self, preset: Preset):
        config: AM2RConfiguration = preset.configuration
