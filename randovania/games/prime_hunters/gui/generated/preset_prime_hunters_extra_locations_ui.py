...
class Ui_PresetHuntersExtraLocations(object):
    ...
    def retranslateUi(self, PresetHuntersExtraLocations):
        ...
        self.shuffle_item_refills_check_box.setText(QCoreApplication.translate("PresetHuntersExtraLocations", u"Enable Item Refill Locations", None))
        self.shuffle_item_refills_label.setText(QCoreApplication.translate("PresetHuntersExtraLocations", u"<html><head/><body><p>Shuffles locations where an Energy, Missile, or Universal Ammo refill is located. This will add an additional 28 locations to the pickup pool.</p><p><span style=\" font-weight:600;\">Number of Locations</span>:</p><ul style=\"margin-top: 0px; margin-bottom: 0px; margin-left: 0px; margin-right: 0px; -qt-list-indent: 1;\"><li style=\" margin-top:12px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Small Energy: 17</li><li style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Medium Energy: 7 (excludes 19 locations from Alinos - Magma Pool)</li><li style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Large Energy: 2 (excludes 2 locations from Oubliette - Gorea 1 Arena)</li><li style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Small Missile Pack: 1</li><"
        ...
        self.shuffle_shield_keys_check_box.setText(QCoreApplication.translate("PresetHuntersExtraLocations", u"Enable Shield Key Locations", None))
