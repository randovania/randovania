...
class Ui_PresetHuntersExtraLocations(object):
    def setupUi(self, PresetHuntersExtraLocations):
        ...
        PresetHuntersExtraLocations.resize(768, 630)
        ...
        self.item_refills_check_box = QCheckBox(self.centralWidget)
        self.item_refills_check_box.setObjectName(u"item_refills_check_box")

        self.verticalLayout.addWidget(self.item_refills_check_box)

        self.item_refills_label = QLabel(self.centralWidget)
        self.item_refills_label.setObjectName(u"item_refills_label")
        sizePolicy = QSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.item_refills_label.sizePolicy().hasHeightForWidth())
        self.item_refills_label.setSizePolicy(sizePolicy)
        self.item_refills_label.setScaledContents(False)
        self.item_refills_label.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignTop)
        self.item_refills_label.setWordWrap(True)

        self.verticalLayout.addWidget(self.item_refills_label)

        self.shield_keys_check_box = QCheckBox(self.centralWidget)
        self.shield_keys_check_box.setObjectName(u"shield_keys_check_box")

        self.verticalLayout.addWidget(self.shield_keys_check_box)

        self.shield_keys_label = QLabel(self.centralWidget)
        self.shield_keys_label.setObjectName(u"shield_keys_label")
        self.shield_keys_label.setWordWrap(True)

        self.verticalLayout.addWidget(self.shield_keys_label)
    ...
    def retranslateUi(self, PresetHuntersExtraLocations):
        ...
        self.item_refills_check_box.setText(QCoreApplication.translate("PresetHuntersExtraLocations", u"Enable Item Refill Locations", None))
        self.item_refills_label.setText(QCoreApplication.translate("PresetHuntersExtraLocations", u"<html><head/><body><p>Shuffles locations where an Energy, Missile, or Universal Ammo refill is located. This will add an additional 28 locations to the pickup pool.</p><p><span style=\" font-weight:600;\">Number of Locations</span>:</p><ul style=\"margin-top: 0px; margin-bottom: 0px; margin-left: 0px; margin-right: 0px; -qt-list-indent: 1;\"><li style=\" margin-top:12px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Small Energy: 17</li><li style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Medium Energy: 7 (excludes 19 locations from Alinos - Magma Pool)</li><li style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Large Energy: 2 (excludes 2 locations from Oubliette - Gorea 1 Arena)</li><li style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Small Missile Pack: 1</li><"
                        "li style=\" margin-top:0px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Large UA Pack: 1 (excludes 2 locations to prevent softlocking)</li></ul></body></html>", None))
        self.shield_keys_check_box.setText(QCoreApplication.translate("PresetHuntersExtraLocations", u"Enable Shield Key Locations", None))
        self.shield_keys_label.setText(QCoreApplication.translate("PresetHuntersExtraLocations", u"<html><head/><body><p>Shuffles locations where a Shield Key is located. Shield Keys are responsible for unlocking doors, Artifact Shields, and Force Fields. This will add an additional 24 locations to the pickup pool.</p><p><span style=\" font-weight:600;\">Shield Key Locations</span>:</p><p><span style=\" font-weight:600;\">Alinos</span></p><ul style=\"margin-top: 0px; margin-bottom: 0px; margin-left: 0px; margin-right: 0px; -qt-list-indent: 1;\"><li style=\" margin-top:12px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Echo Hall</li><li style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Elder Passage</li><li style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">High Ground</li><li style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Crash Site</li><li style=\" margin-t"
