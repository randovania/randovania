...
class Ui_HuntersGameTabWidget(object):
    ...
    def retranslateUi(self, HuntersGameTabWidget):
        ...
        self.differences_label.setText(QCoreApplication.translate("HuntersGameTabWidget", u"<html><head/><body><p>Various changes have been made to the game to enhance the randomizer experience. These include:</p><ul style=\"margin-top: 0px; margin-bottom: 0px; margin-left: 0px; margin-right: 0px; -qt-list-indent: 1;\"><li style=\" margin-top:12px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">All planets, except Oubliette, are accessible from the start.</li><ul style=\"margin-top: 0px; margin-bottom: 0px; margin-left: 0px; margin-right: 0px; -qt-list-indent: 1;\"><li style=\" margin-top:12px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Various cutscenes and tutorial texboxes have been removed.</li></ul><li style=\" margin-top:12px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">The number of Octoliths required to unlock Oubliette is configurable. The lore scans in <span style=\" font-weight:600;\">Alimbic Cannon Control Room</span> will provide hints to whe"
                        "re they can be found.</li><li style=\" margin-top:12px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">The force fields that block access to later parts of planets prior to defeating the first boss of the planets have been removed.</li><ul style=\"margin-top: 0px; margin-bottom: 0px; margin-left: 0px; margin-right: 0px; -qt-list-indent: 1;\"><li style=\" margin-top:12px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">The escape sequences that occur after defeating the bosses have been removed. This also means the portals that connect to the landing sites can be used without having to leave the planet first.</li></ul><li style=\" margin-top:12px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">The fight trigger in Celestial Archives - Data Shrine 01 is now activated by scanning the panel below the pickup to prevent softlocks.</li><li style=\" margin-top:12px; margin-bottom:"
                        "12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">A proper Missile Launcher pickup has been added which is required in order to fire Missiles.</li><li style=\" margin-top:12px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Many rooms have been modified with regards to how the doors lock and unlock to prevent softlocks.</li><li style=\" margin-top:12px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Scan Points have been added above portals that tells their destination.</li><li style=\" margin-top:12px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Various other minor fixes throughout to improve gameplay.</li></ul></body></html>", None))
