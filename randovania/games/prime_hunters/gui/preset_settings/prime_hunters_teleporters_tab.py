...
from randovania.games.prime_hunters.gui.generated.preset_teleporters_prime_hunters_ui import (
    Ui_PresetTeleportersHunters,
)
...
class PresetTeleportersHunters(PresetTeleporterTab[HuntersConfiguration], Ui_PresetTeleportersHunters, NodeListHelper):
    teleporter_mode_to_description = {
        ...
        TeleporterShuffleMode.ONE_WAY_TELEPORTER: (
            ...
            "All rooms are used as a destination exactly once, causing all portals to be separated into loops."
        ),
        TeleporterShuffleMode.ONE_WAY_TELEPORTER_REPLACEMENT: (
            "All portals bring you to a portal room, but going backwards can go somewhere else. "
            "Rooms can be used as a destination multiple times, causing portals which you can possibly"
            " not come back to."
        ),
    }
    ...
    def on_preset_changed(self, preset: Preset[HuntersConfiguration]) -> None:
        ...
        descriptions = [
            "<p>Controls where each portal connects to.</p>",
