...
class Ui_PresetMSRPatches(object):
    def setupUi(self, PresetMSRPatches):
        ...
        self.scroll_contents.setGeometry(QRect(0, 0, 626, 844))
    ...
    def retranslateUi(self, PresetMSRPatches):
        ...
        self.charge_door_buff_label.setText(QCoreApplication.translate("PresetMSRPatches", u"Makes Charge Doors invulnerable to Power Bombs and Beam Burst.", None))
