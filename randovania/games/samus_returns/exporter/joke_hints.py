...
JOKE_HINTS = [
    ...
    "Whoops, it seems the Metroids ate this hint!",
    "It seems this Chozo Seal ran out of bird magic to generate a hint.",
    "Uh oh! It seems your Metroid can't crawl.\nPlease contact your Chozo Representative for help.",
    ...
    "You may be able communicate with Metroids by speaking into the 3DS microphone.\nResults may vary.",
