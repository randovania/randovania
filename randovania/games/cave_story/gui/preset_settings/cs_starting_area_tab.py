...
class PresetCSStartingArea(PresetStartingArea):
    ...
    def _starting_location_on_select_classic(self, area: PresetStartingArea) -> None:
        classics = [
    ...
    def _starting_location_on_select_save_point(self, area: PresetStartingArea) -> None:
