...
################################################################################
## Form generated from reading UI file 'games_tab_prime_2_echoes_widget.ui'
##
...
class Ui_EchoesGameTabWidget(object):
    ...
    def retranslateUi(self, BlankGameTabWidget):
        ...
        self.intro_label.setText(QCoreApplication.translate("EchoesGameTabWidget", u"<html><head/><body><p align=\"justify\">The Blank game is used by Randovania to serve as an example of how a game is integrated.</p></body></html>", None))
        self.quick_generate_button.setText(QCoreApplication.translate("EchoesGameTabWidget", u"Quick generate", None))
        BlankGameTabWidget.setTabText(BlankGameTabWidget.indexOf(self.tab_intro), QCoreApplication.translate("EchoesGameTabWidget", u"Introduction", None))
        BlankGameTabWidget.setTabText(BlankGameTabWidget.indexOf(self.tab_generate_game), QCoreApplication.translate("EchoesGameTabWidget", u"Play", None))
        self.faq_label.setText(QCoreApplication.translate("EchoesGameTabWidget", u"# updated from code", None))
        BlankGameTabWidget.setTabText(BlankGameTabWidget.indexOf(self.faq_tab), QCoreApplication.translate("EchoesGameTabWidget", u"FAQ", None))
        BlankGameTabWidget.setTabText(BlankGameTabWidget.indexOf(self.pickup_hint_features_tab), QCoreApplication.translate("EchoesGameTabWidget", u"Pickup Hint Features", None))
        pass
    # retranslateUi
