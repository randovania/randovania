...
################################################################################
## Form generated from reading UI file 'prime_2_echoes_cosmetic_patches_dialog.ui'
##
...
class Ui_EchoesCosmeticPatchesDialog(object):
    ...
    def retranslateUi(self, BlankCosmeticPatchesDialog):
        BlankCosmeticPatchesDialog.setWindowTitle(QCoreApplication.translate("EchoesCosmeticPatchesDialog", u"Echoes Game - Cosmetic Options", None))
