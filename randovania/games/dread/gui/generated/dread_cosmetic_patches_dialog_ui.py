...
class Ui_DreadCosmeticPatchesDialog(object):
    ...
    def retranslateUi(self, DreadCosmeticPatchesDialog):
        ...
        self.separate_save_slots.setText(QCoreApplication.translate("DreadCosmeticPatchesDialog", u"Use separate save data for this game", None))
        self.save_slots_description.setText(QCoreApplication.translate("DreadCosmeticPatchesDialog", u"<html><head/><body><p>This setting changes the internal name of Dread's save files to be specific to the randomizer you are playing. This setting simplifies the process of playing multiple randomizers (such as playing a solo randomizer during an asynchronous multiworld). </p><p>This will increase the space used by save data (by approximately 250 KB per save slot).</p></body></html>", None))
