...
################################################################################
## Form generated from reading UI file 'preset_prime_origins_energy.ui'
##
...
class Ui_PresetPrimeOriginsEnergy(object):
    def setupUi(self, PresetPrimeOriginsEnergy):
        if not PresetPrimeOriginsEnergy.objectName():
            PresetPrimeOriginsEnergy.setObjectName(u"PresetPrimeOriginsEnergy")
        PresetPrimeOriginsEnergy.resize(476, 628)
        self.centralWidget = QWidget(PresetPrimeOriginsEnergy)
        ...
        PresetPrimeOriginsEnergy.setCentralWidget(self.centralWidget)

        self.retranslateUi(PresetPrimeOriginsEnergy)

        QMetaObject.connectSlotsByName(PresetPrimeOriginsEnergy)
    # setupUi

    def retranslateUi(self, PresetPrimeOriginsEnergy):
        PresetPrimeOriginsEnergy.setWindowTitle(QCoreApplication.translate("PresetPrimeOriginsEnergy", u"Energy", None))
        self.energy_tank_box.setTitle(QCoreApplication.translate("PresetPrimeOriginsEnergy", u"Energy tank", None))
        self.energy_tank_capacity_label.setText(QCoreApplication.translate("PresetPrimeOriginsEnergy", u"Energy per tank", None))
        self.energy_tank_capacity_spin_box.setSuffix(QCoreApplication.translate("PresetPrimeOriginsEnergy", u" energy", None))
        self.energy_tank_capacity_description.setText(QCoreApplication.translate("PresetPrimeOriginsEnergy", u"<html><head/><body><p>Configure how much energy each Energy Tank you collect will provide. Your base energy is always this quantity, minus 1.</p><p>While logic will respect this value, only the original value (100) has been tested.</p></body></html>", None))
        self.damage_reduction_box.setTitle(QCoreApplication.translate("PresetPrimeOriginsEnergy", u"Damage reduction", None))
        self.damage_reduction_label.setText(QCoreApplication.translate("PresetPrimeOriginsEnergy", u"<html><head/><body><p>Configure how damage reduction is applied, according to what suits you have:</p><p><span style=\" font-weight:704;\">Original:</span> Having Varia Suit reduces damage by 10%, Gravity Suit by 20%, and Phazon Suit by 50%. The highest value suit overrides other suits.</p><p><span style=\" font-weight:704;\">Progressive:</span> Having one suit reduces damage by 10%, two suits by 20%, and having all suits reduces damage by 50%.</p><p><span style=\" font-weight:704;\">Additive:</span> Each suit has a respective damage reduction value, which are added together to determine total damage reduction. Varia and Gravity Suit each add 10% to total damage reduction, and Phazon Suit adds 30%. Phazon and one other suit would reduce damage by 40% total.</p></body></html>", None))
        self.damage_reduction_combo.setItemText(0, QCoreApplication.translate("PresetPrimeOriginsEnergy", u"Original", None))
        self.damage_reduction_combo.setItemText(1, QCoreApplication.translate("PresetPrimeOriginsEnergy", u"Progressive", None))
        self.damage_reduction_combo.setItemText(2, QCoreApplication.translate("PresetPrimeOriginsEnergy", u"Additive", None))

        self.heated_damage_box.setTitle(QCoreApplication.translate("PresetPrimeOriginsEnergy", u"Heated rooms", None))
        self.heated_damage_spin.setSuffix(QCoreApplication.translate("PresetPrimeOriginsEnergy", u" energy/s", None))
        self.heated_damage_label.setText(QCoreApplication.translate("PresetPrimeOriginsEnergy", u"Heated damage rate", None))
        self.heated_damage_description.setText(QCoreApplication.translate("PresetPrimeOriginsEnergy", u"<html><head/><body><p>Configure how much damage per second you take in heated rooms, when you don't have proper protection.</p></body></html>", None))
        self.ingame_difficulty_box.setTitle(QCoreApplication.translate("PresetPrimeOriginsEnergy", u"In-Game Difficulty", None))
        self.ingame_difficulty_label.setText(QCoreApplication.translate("PresetPrimeOriginsEnergy", u"<html><head/><body><p>Control how the in-game difficulty options are presented to the player when starting a new Save Slot in the Main Menu:</p><p><span style=\" font-weight:700;\">Normal: </span>The player is forced to select &quot;Normal&quot; difficulty</p><p><span style=\" font-weight:700;\">Hard: </span>The player is forced to select &quot;Hard&quot; difficulty and the seed will be generated using adjusted damage/energy requirements</p><p><span style=\" font-weight:700;\">Either (Not Recommended): </span>The player may select either the difficulty. If the player chooses to play on &quot;Hard&quot;, the seed may not be completable because of logic differences</p></body></html>", None))
        self.ingame_difficulty_combo.setItemText(0, QCoreApplication.translate("PresetPrimeOriginsEnergy", u"Normal", None))
        self.ingame_difficulty_combo.setItemText(1, QCoreApplication.translate("PresetPrimeOriginsEnergy", u"Hard", None))
        self.ingame_difficulty_combo.setItemText(2, QCoreApplication.translate("PresetPrimeOriginsEnergy", u"Either", None))
