...
################################################################################
## Form generated from reading UI file 'games_tab_prime_origins_widget.ui'
##
...
class Ui_MPOGameTabWidget(object):
    ...
    def retranslateUi(self, BlankGameTabWidget):
        self.game_cover_label.setText(QCoreApplication.translate("MPOGameTabWidget", u"TextLabel", None))
        self.intro_label.setText(QCoreApplication.translate("MPOGameTabWidget", u"<html><head/><body><p align=\"justify\">The Blank game is used by Randovania to serve as an example of how a game is integrated.</p></body></html>", None))
        self.quick_generate_button.setText(QCoreApplication.translate("MPOGameTabWidget", u"Quick generate", None))
        BlankGameTabWidget.setTabText(BlankGameTabWidget.indexOf(self.tab_intro), QCoreApplication.translate("MPOGameTabWidget", u"Introduction", None))
        BlankGameTabWidget.setTabText(BlankGameTabWidget.indexOf(self.tab_generate_game), QCoreApplication.translate("MPOGameTabWidget", u"Play", None))
        self.faq_label.setText(QCoreApplication.translate("MPOGameTabWidget", u"# updated from code", None))
        BlankGameTabWidget.setTabText(BlankGameTabWidget.indexOf(self.faq_tab), QCoreApplication.translate("MPOGameTabWidget", u"FAQ", None))
        BlankGameTabWidget.setTabText(BlankGameTabWidget.indexOf(self.pickup_hint_features_tab), QCoreApplication.translate("MPOGameTabWidget", u"Pickup Hint Features", None))
        pass
    # retranslateUi
