...
################################################################################
## Form generated from reading UI file 'prime_origins_cosmetic_patches_dialog.ui'
##
...
class Ui_MPOCosmeticPatchesDialog(object):
    ...
    def retranslateUi(self, BlankCosmeticPatchesDialog):
        BlankCosmeticPatchesDialog.setWindowTitle(QCoreApplication.translate("MPOCosmeticPatchesDialog", u"MPO Game - Cosmetic Options", None))
        self.reset_button.setText(QCoreApplication.translate("MPOCosmeticPatchesDialog", u"Reset to Defaults", None))
        self.accept_button.setText(QCoreApplication.translate("MPOCosmeticPatchesDialog", u"Accept", None))
        self.cancel_button.setText(QCoreApplication.translate("MPOCosmeticPatchesDialog", u"Cancel", None))
    # retranslateUi
