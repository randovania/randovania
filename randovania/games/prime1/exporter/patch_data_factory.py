...
class PrimePatchDataFactory(BasePatchDataFactory):
    ...
    def create_data(self) -> dict:
        ...
        return {
            ...
            "randScaleMin": self.configuration.enemy_rando_range_scale_low,
            "randScaleMax": self.configuration.enemy_rando_range_scale_high,
            "randHealthMin": self.configuration.enemy_rando_range_health_low,
            "randHealthMax": self.configuration.enemy_rando_range_health_high,
            "randSpeedMin": self.configuration.enemy_rando_range_speed_low,
            "randSpeedMax": self.configuration.enemy_rando_range_speed_high,
            "randDamageMin": self.configuration.enemy_rando_range_damage_low,
            "randDamageMax": self.configuration.enemy_rando_range_damage_high,
            "randKnockbackMin": self.configuration.enemy_rando_range_knockback_low,
            "randKnockbackMax": self.configuration.enemy_rando_range_knockback_high,
            "diffXYZ": self.configuration.enemy_rando_diff_xyz,
