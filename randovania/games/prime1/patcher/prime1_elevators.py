...
RANDOM_PRIME_CUSTOM_NAMES = {
    ...
    # 45
    AreaLocation(2831049361, 3222157185): 'Phendrana Drifts North\0(Phendrana Shorelines)',
    # 1900634
    AreaLocation(2831049361, 3708487481): 'Phendrana Drifts South\0(Quarantine Cave)',
    # 134218592
    AreaLocation(361692695, 3508802073): 'Exterior Docking Hangar',
    # 31
    AreaLocation(1056449404, 1005235657): 'Magmoor Caverns North\0(Lava Lake)',
    # 852002
    AreaLocation(1056449404, 3702104715): 'Magmoor Caverns West\0(Monitor Station)',
    # 1048608
    AreaLocation(1056449404, 1279075404): 'Magmoor Caverns East\0(Twin Fires)',
    # 1703972
    AreaLocation(1056449404, 4012840000): 'Magmoor Caverns South\0(Magmoor Workstation, Debris)',
    # 1769512
    AreaLocation(1056449404, 3249312307): 'Magmoor Caverns South\0(Magmoor Workstation, Save Station)',
    AreaLocation(2980859237, 1125030300): 'Phazon Mines East\0(Main Quarry)',  # 28
    # 1638417
    AreaLocation(2980859237, 3804417848): 'Phazon Mines West\0(Phazon Processing Center)',
    # 917509
    AreaLocation(972217896, 295707720): 'Tallon Overworld North\0(Tallon Canyon)',
    AreaLocation(972217896, 597223686): 'Artifact Temple',  # 1049306
    # 1441848
    AreaLocation(972217896, 2318493278): 'Tallon Overworld East\0(Frigate Crash Site)',
    # 1507378
    AreaLocation(972217896, 366411659): 'Tallon Overworld West\0(Root Cave)',
    # 2687012
    AreaLocation(972217896, 212145392): 'Tallon Overworld South\0(Great Tree Hall, Upper)',
    # 2818083
    AreaLocation(972217896, 2098226800): 'Tallon Overworld South\0(Great Tree Hall, Lower)',
    AreaLocation(2214002543, 1047210935): 'Chozo Ruins West\0(Main Plaza)',  # 125
    # 1572903
    AreaLocation(2214002543, 2199318005): 'Chozo Ruins North\0(Sun Tower)',
    # 4063276
    AreaLocation(2214002543, 2784651681): 'Chozo Ruins East\0(Reflecting Pool, Save Station)',
    # 4128808
    AreaLocation(2214002543, 594418447): 'Chozo Ruins South\0(Reflecting Pool, Far End)',
