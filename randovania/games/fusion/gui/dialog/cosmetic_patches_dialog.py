...
from randovania.games.fusion.layout.blank_cosmetic_patches import FusionCosmeticPatches
...
class FusionCosmeticPatchesDialog(BaseCosmeticPatchesDialog, Ui_BlankCosmeticPatchesDialog):
