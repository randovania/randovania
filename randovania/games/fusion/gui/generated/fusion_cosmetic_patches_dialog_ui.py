...
class Ui_FusionCosmeticPatchesDialog(object):
    def setupUi(self, FusionCosmeticPatchesDialog):
        ...
        self.scroll_area_contents.setGeometry(QRect(0, 0, 680, 535))
    ...
    def retranslateUi(self, FusionCosmeticPatchesDialog):
        ...
        self.suit_palette_check.setText(QCoreApplication.translate("FusionCosmeticPatchesDialog", u"Randomize Suit Palette", None))
        self.beam_palette_check.setText(QCoreApplication.translate("FusionCosmeticPatchesDialog", u"Randomize Beam Palette", None))
        self.enemy_palette_check.setText(QCoreApplication.translate("FusionCosmeticPatchesDialog", u"Randomize Enemy Palette", None))
        self.tileset_palette_check.setText(QCoreApplication.translate("FusionCosmeticPatchesDialog", u"Randomize Tileset Palette", None))
