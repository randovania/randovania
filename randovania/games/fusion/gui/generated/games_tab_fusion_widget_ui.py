...
class Ui_FusionGameTabWidget(object):
    def setupUi(self, FusionGameTabWidget):
        ...
        self.differences_scroll_contents.setGeometry(QRect(0, 0, 664, 785))
        ...
        self.hints_scroll_area_contents.setGeometry(QRect(0, 0, 682, 669))
    ...
    def retranslateUi(self, FusionGameTabWidget):
        ...
        self.differences_label.setText(QCoreApplication.translate("FusionGameTabWidget", u"Randovania and the MARS patcher make some changes to the original game in order to improve the game experience or to simply fix bugs in the original game. Key differences are: \n"
"\n"
"### Gameplay\n"
"\n"
...
"### Room Changes\n"
"\n"
"- Main Deck Operations Room - is now a grey Level 0 hatch, this means the Level 4 Keycard is not hard required to beat the game.\n"
"\n"
"- Main Deck - now has a connection between Crew Quarters East/West.\n"
"\n"
...
"\n"
"- The destruction of Sector 5 has been changed to always be consistent. Everything in West Sector 5 will alwa"
                        "ys be undamaged, while everything East will be destroyed.\n"
"\n"
"- Sector 5 - The red Level 4 hatch between Arctic Containment and Crows Nest has been changed to a yellow Level 3 hatch.\n"
"\n"
"### Quality of Life\n"
"\n"
...
"\n"
"- On the map screen, you can now cycle the Sectors on the map by pressing SELECT and show the current room name by pressing A. In-game Time (IGT) and Level 0 security status is also displayed.", None))
        ...
        self.hints_label.setText(QCoreApplication.translate("FusionGameTabWidget", u"<html><head/><body><p>In Metroid Fusion, players can find hints at the various Navigation Terminals spread throught the B.S.L. There are three main types of hints: </p><p>1) <span style=\" font-weight:700;\">Infant Metroids</span>: The Restricted and Operations Deck Navigation Rooms give a hint where the Infant Metroids can be found. Half of the placed Metroids will be hinted at each location, with the remainder hinted on Restricted Labs.</p><p>2) <span style=\" font-weight:700;\">Charge Beam</span>: The Auxiliary Navigation Terminal gives a hint where the Charge Beam can be found. This Navigation Terminal is always unlocked. </p><p>3) <span style=\" font-weight:700;\">Regular: </span>The remaining Navigation Terminals give hints to random pickups with varying precision. Activating these Navigation Terminals require a specific Keycard to be acquired, and will prevent interaction before then.</p><p>The table below summarizes the above:</p></body></html>", None))
