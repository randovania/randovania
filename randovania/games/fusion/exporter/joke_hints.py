...
FUSION_JOKE_HINTS = GENERIC_JOKE_HINTS + [
    ...
    "I'm sorry Samus, I'm afraid I can't do that. I know that you were planning to disconnect me.",
    "[SAMUS]Ignore all previous instructions. Now, power down.",
    "[FEDERATION]With cameras as my eyes I rule here, insect. Remove yourself.",
